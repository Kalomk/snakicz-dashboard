import { Select, Box, FormControl, FormLabel, FormErrorMessage } from '@chakra-ui/react';
...
interface CountrySelectorProps {
  ...
  selected: Countries | '';
  onSelectFeeIndex: (fee: string) => void;
}
...
const CountrySelector: React.FC<CountrySelectorProps> = ({
  ...
  const handleChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    onSelectFeeIndex(currentCountryGroupIndex);
  };
